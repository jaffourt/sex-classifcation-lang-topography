...
def build_model():
    model = keras.Sequential([
        keras.layers.Conv1D(8,1,input_shape=(1,415140),padding='Same',activation='relu'),
        keras.layers.Conv1D(16, 1, padding='Same',activation='relu'),
    # model.add(BatchNormalization())
        keras.layers.MaxPool1D(pool_size=(1)),
        keras.layers.Dropout(0.25),
        keras.layers.Conv1D(32, 1, padding='Same',activation='relu'),
        keras.layers.Conv1D(64, 1, padding='Same',activation='relu'),
